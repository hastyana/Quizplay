        ...
        <div class="container mx-auto flex justify-center">
            <div class="w-full py-0 px-5 space-y-5">
                ...
                <div class="flex justify-between items-center">
                    <a href="{{ url('guru/room/'.$detail->id.'/quiz_add') }}" type="button" class="group relative flex w-auto justify-center rounded-md bg-orange-400 px-3 py-2 text-xl font-semibold text-white hover:bg-gray-400 shadow shadow-gray-400">
                        + <span class="px-2"> | </span> Soal
                    </a>
                    <a href="{{ url('guru/room/'.$detail->id.'/standing') }}" type="button" class="group relative flex w-auto justify-center rounded-md bg-orange-400 px-3 py-2 text-xl font-semibold text-white hover:bg-gray-400 shadow shadow-gray-400">
                        Ranking
                    </a>
                </div>                       
                <!-- New Table -->
                        ...
                        <table class="w-full whitespace-no-wrap">
                            ...
                            <tbody class="bg-white-fafafa divide-y">
                                ...
                                <tr class="text-white">
                                    ...
                                    <td class="px-4 py-3 text-sm">
                                        <img class="w-20 h-auto items-center justify-center" src="{{ asset('quiz/'.$row->image) }}" alt="{{ $row->image }}">
                                    </td> 
                                    <td class="px-4 py-3 text-sm">
                                        {!! $row->question !!} <br>
                                       A. {{ $row->a }} <br>
